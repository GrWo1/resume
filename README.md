<h2 align="center"> Резюме (Python-backend Django)</h2>
...
"Хорошо делай и хорошо будет!"

Более 4 лет изучаю инструменты для создания сайтов. Несколько  последних лет работал на CMS Joomla(выполнял проекты на фрилансе). В какой-то момент решил посмотреть, а как создается web-интерфейс для управления сайтами. Так начал знакомиться с фреймворком Django. Сначала изучал самостоятельно. В марте 2022 года решил поступить на курс от Яндекс.Практикума, чтобы структурировать знания и поменять профессию. Нахожу для себя крайне интересным сферу разработки web-продуктов, программирования и готов дальше развиваться в этой области.
Есть 10 летний опыт работы с компьютерным железом и ПО. Имеются познания в построении ЛВС и ремонте компьютерной периферии.
Знакомые и коллеги не раз подчеркивали мою стрессоустойчивость. Несмотря на различные ситуации очень редко поддаюсь панике. Присуще высокое желание помочь людям(возможно поэтому записался в программу "Старший студент". Помогаю новым студентам изучать курс на Практикуме). Стараюсь грамотно и четко формулировать мысли. Ответственно подхожу к решению поставленных задач. Возникающие проблемы до последнего пытаюсь решить самостоятельно.
...
* 2023 - настоящий момент -- Инженер-разработчик C++
